  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <Text fontSize="3xl" fontFamily="Work sans bold" fontWeight="bold" color="black">
          Text-A-Lot
        </Text>
          ...
          <Menu>
            ...
            <MenuList bg="white" borderColor="black" borderWidth="2px">
              <ProfileModal user={user}>
                <MenuItem fontWeight="bold" color="black" _hover={{ background: "white" }}>
                  My Profile
                </MenuItem>
              </ProfileModal>
              <MenuDivider />
              <MenuItem fontWeight="bold" color="black" onClick={logoutHandler} _hover={{ background: "white" }}>
                Logout
              </MenuItem>
            </MenuList>
          </Menu>
